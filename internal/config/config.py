...
class HarvestConfig:
    def __init__(self):
        ...
        self.strategy_volatility_enter_lower = os.getenv("STRATEGY_VOLATILITY_ENTER_LOWER", None)
        self.strategy_volatility_enter_upper = os.getenv("STRATEGY_VOLATILITY_ENTER_UPPER", None)
